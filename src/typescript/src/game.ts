...
export class Game {
    ...
    game_over_window_x: number = 0
    game_over_window_y: number = 0
    game_over_window_width: number = 0
    game_over_window_height: number = 0
    ...
    constructor() {
        ...
        this.game_over_window_x = 100
        this.game_over_window_y = 100
        this.game_over_window_width = 50
        this.game_over_window_height = 50
        this.game_over_button = new Button(100, 50, 100, 100, "replay","white")
    }
    spawnTrain() {
    ...
    async drawGameOver(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D) {
        ...
        this.game_over_button.draw(ctx)
    }
    ...
    windowResize(canvas: HTMLCanvasElement) {
        ...
        this.game_over_window_x = canvas.width - this.game_over_window_width
        this.game_over_window_y = canvas.height - this.game_over_window_height
        this.game_over_window_width = this.score_window_width
        this.game_over_window_height = this.score_window_height
    ...
    click(e: MouseEvent, canvas: HTMLCanvasElement) {
        ...
        switch (this.state) {
            ...
            case 2:// game
                ...
                break
            case 3:
                if (this.game_over_button.isPressed(x, y)) {
                    this.state = 1
                }
                break
            default:
